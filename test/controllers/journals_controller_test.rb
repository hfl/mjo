...
class JournalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal" do
    assert_difference('Journal.count') do
      post journals_url, params: { journal: { about: @journal.about, issn: @journal.issn, name: @journal.name } }
    end
  ...
  test "should update journal" do
    patch journal_url(@journal), params: { journal: { about: @journal.about, issn: @journal.issn, name: @journal.name } }
