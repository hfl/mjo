...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post keywords_url, params: { keyword: { article_id: @keyword.article_id, keyword: @keyword.keyword } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { article_id: @keyword.article_id, keyword: @keyword.keyword } }
